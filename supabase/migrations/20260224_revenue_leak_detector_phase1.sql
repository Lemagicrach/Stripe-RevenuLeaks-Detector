-- supabase/migrations/20260224_revenue_leak_detector_phase1.sql
...
CREATE TABLE IF NOT EXISTS public.revenue_leaks (
  ...
  leak_type TEXT NOT NULL, -- failed_payments | recovery_gap | churn_spike | silent_churn | expansion_opportunity
  ...
  confidence NUMERIC(3,2) NOT NULL DEFAULT 0.70, -- 0..1
